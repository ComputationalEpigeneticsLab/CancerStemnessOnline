UserTaskID="User";
webpath="example/userBulk/DownStream";
methods_end_re="";
...
if(methods_end_re.stopMessage=="no"){
	...
	document.getElementById('download_exp').href ="download_loading.jsp?path=example/select_TCGA_LUAD_exp_TPM.txt&name="+UserTaskID+"_Expression_Example.txt";
	document.getElementById('download_sample').href ="download_loading.jsp?path=example/TCGA_LUAD_user_sample_infor.txt&name="+UserTaskID+"_Sample_information_Example.txt";
	// steam sig gen table
	...
	//survival
		if (methods_end_re.survival_infor=="yes"){
			...
			document.getElementById("cox_beta").innerHTML= methods_end_re.survival_cox_beta_v+" ("+methods_end_re.survival_cox_beta_class+")";
			//img
