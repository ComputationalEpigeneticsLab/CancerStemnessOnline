...
if(methods_end_re.stopMessage=="no"){
	...
	var datatype0="";
	if (methods_end_re.dataType=="bulk"){datatype0="bulk RNA-seq"}else{datatype0="scRNA-seq"}
	...
	//barplot
		...
		document.getElementById('download_sample').href ="download_loading.jsp?path=example/TCGA_LUAD_feature_use.txt&name="+UserTaskID+"_Sample_information_Example.txt";
