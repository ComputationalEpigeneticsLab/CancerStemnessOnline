UserTaskID="StemnessIndex";
webpath="example/StemnessIndex/DownStream";
methods_end_re="";
...
if(methods_end_re.stopMessage=="no"){
	...
	document.getElementById('download_clinical').href ="download_loading.jsp?path=example/TCGA_LUAD_clinical.txt&name="+UserTaskID+"_Clinical_information_Example.txt";
