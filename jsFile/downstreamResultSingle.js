...
//webpath="upload/singleexample/DownStream";
methods_end_re="";
	...
	//cell cell com
		...
		if (methods_end_re.compare_score_error=="no"){
			...
			if(method=="StemSC"){
				...
				document.getElementById("method_compareTable_mRNAsi_img").src = webpath+"/Unsupervised_CytoTRACE_scatter.png";
			
				
				
		}else if (method=="CytoTRACE"){
			///
			document.getElementById("mRNAsi_all").style.display="none";
			document.getElementById("both_all").style.display="none";
			document.getElementById("CytoTRACE_all").style.display="block";
			document.getElementById("method_compareTable_CytoTRACE_img").src = webpath+"/Supervised_StemSC_scatter.png";
