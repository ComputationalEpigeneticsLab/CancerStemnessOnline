        ...
        <div class="row">
        	<div class="col-lg-12 ">
        		<div class="sidebar" >
        			...
        			<div id="RNA_v" style="margin-top:10px;margin-bottom:10px;">
        				<div class="uploadTitle">
        					<i  class="fa fa-th-list" aria-hidden="true" style="font-size:30px;"></i> Single-cell trajectory analysis
        					 
        				</div>
        				<div id="rna_v_d" style="min-height:500px;"> 
	        				<br/>
	        				<strong style="font-size:20px;" id="">The trajectory of cancer cells colored by pesudotime and CSscore, respectively </strong>
	        				<div id="load_v">
	        				 <i style="font-size:40px;color:red;" class='bx bx-loader bx-spin'></i> <font style="color:black;font-size:22px;"> It will  spend some time </font>
	        				</div>
	        				...
	        				<div class="row">
		        				...
		        				<div class="col-lg-6 ">
		        					<div id="csscore" style="height:500px;"></div>
		        				</div>
        			...
        			<div id="bulk">
        				...
        				<div class="layui-tab layui-tab-card" id="singleOption">
						  <ul class="layui-tab-title" style="font-size:20px;font-weight:550">
						    <li class="layui-this" style="font-size:20px;font-weight:550">Samples</li>
						    <li style="font-size:22px;font-weight:550">Treatment</li>
						  </ul>
						  <div class="layui-tab-content" style="min-height:500px;">
						    <div class="layui-tab-item layui-show" id="Sample_source_exp">
								<div id="Sample_source_pie" class="imgleft"></div>
								<div id="Sample_source_violin" class="imgright"></div>
						    </div>
						    <div class="layui-tab-item" id="Drug_treatment_exp">
								<div id="Drug_treatment_pie" class="imgleft"></div>
								<div id="Drug_treatment_violin" class="imgright"></div>
						    </div>
						  </div>
						</div>
        			</div>
...
<script src="js/csIdentityResultMultSingle.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
