...
<!--         					</tr> -->
        					...
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">Sample information  file  </th>
        					...
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">No. of samples</th>
        			...
        			<div id="function" style="margin-top:20px;">
        				...
        				<div class="layui-tab layui-tab-card">
						  <ul class="layui-tab-title">
						    ...
						    <li style="font-size:20px;font-weight:550;"> Cancer immunity</li>
						  </ul>
	...
	<div class="img_wrap4">
		<img  id="immScatterPlot" src="upload/2ZZ3LdJ4P8_111@qq.com/DownStream/scatter/AIMP1_scatter.png" alt="Immune cell Scatter Plot"  >
								...
								<br/>
									<div>
										<span>
											<strong class="fontStyle3">The visualization of associations among cancer stemness and cell types</strong>
											<span>
									...
									<div>
										<span>
											<strong class="fontStyle3">Heatmap - correlation beween cell types</strong>
											<span>
        			...
        			<div id="clinical" style="margin-top:20px;">
        				<div class="uploadTitle">
	        				<i  class="fa fa-file-text-o" aria-hidden="true" style="font-size:30px;"></i> Survival analysis
	        			</div>
        				<div class="ant-descriptions-view" style="margin-top:10px;margin-bottom:20px;">
	        				<table style="width:100%">
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">P value (cox regression)</th>
        						<td id="cox_p" class="ant-descriptions-item-content"></td>
        					</tr>
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">Beta value</th>
        						<td id="cox_beta" class="ant-descriptions-item-content"></td>
        					</tr>
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">P value (log rank)</th>
        						<td id="logrank_p" class="ant-descriptions-item-content"></td>
        					</tr>
	        			...
	        			<br/>
	        						<div style="margin-left:10px;">
										<span>
											<strong class="fontStyle3">Kaplan-Meier plot</strong>
											<span>
												<a id="SurvivalplotDownload" href="download_loading.jsp?path=example/example_normal/Res_cellPredictDownload.txt&name=example_normal.txt" title="download table">
													<i class="fa fa-arrow-circle-o-down" aria-hidden="true" style="font-size:23px;" ></i>
												</a>									     		
											</span>
										</span>
										<div id="" class="img_wrap3">
											<img  id="Survivalplot" src="" alt="Survival Plot"  >
										</div>
									</div>
	        			</div>
        			</div>
	        				...
	        				<span>
								...
								<div id="jobid_compare" style="margin-top:10px;margin-left:10px;margin-bottom:50px;">
									<table style="text-align:left;font-size:16px;width:100%;" id="method_compareTable" class="table table-bordered table-hover dataTable cell_infor_table_detail" >
										<thead style="text-align:left;font-size:18px;">
											<tr>
												<th style="">Sample </th>
												<th >User defined</th>
												<th >Supervised_mRNAsi</th>
												<th >Unsupervised_GSVA</th>
									...
									<div id="both_img_r" class="imgright2">
										<img  id="method_compareTable_right" src="" alt=" GSVA scatter"  >
									</div>
        			...
        			<a href="exampleDownStreamResultSingleUser.jsp">
	        				<i class="fa fa-eye" aria-hidden="true" style="font-size:30px;"></i> View example of single-cell data
	        				</a>
	        			</div>
...
<script src="js/exampledownstreamResultBulkUser.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
