...
<!--         					</tr> -->
        					<tr class="ant-descriptions-row">
        						<th class="ant-descriptions-item-label">Clinical  file  </th>
        						<td id="clinicalfile" class="ant-descriptions-item-content"></td>
        						<td id="" class="ant-descriptions-item-content">
        						<a id="download_clinical" href="">
									<button style="height:35px;width:100px; border:1px solid #B0477E;color:white; background:#B0477E;opacity:0.8;border-radius:10px;font-size:16px;">Download</button>
	        					</a>
        						</td>
        					</tr>
	...
	<div class="img_wrap4">
		<img  id="immScatterPlot" src="upload/2ZZ3LdJ4P8_111@qq.com/DownStream/scatter/AIMP1_scatter.png" alt="Immune cell Scatter Plot"  >
								...
								<br/>
									<div>
										<span>
											<strong class="fontStyle3">The heatmap for  infiltration of cell types</strong>
											<span>
									...
									<div>
										<span>
											...
											The visualization of associations among cancer stemness and cell types
											</strong>
											<span>
        			...
        			<a href="exampleDownStreamResultSingle.jsp">
...
<script src="js/exampledownstreamResultBulk.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
