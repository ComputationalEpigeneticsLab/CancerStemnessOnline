  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container" style="margin-top:40px;">
        <h2>GSVA</h2>
        <div id="GSVA_c" class="methodDiscription">
        	<p class="methodDiscriptionDetail">
        	The score of single cell gene set enrichment analysis (ssGSEA) for our manually collected stemness-related signatures. The cell stemness scores were normalized within 0 to 1.
<!-- <br/>Signatures are collected from studies below.</p >  -->
...
<!-- 								</td> -->
							...
							<tr id="filetypeOption">
								<td>
									<div  style="width:px;"><p style="font-size:20px;font-weight:700">Data type </p></div>
								</td>
								<td style="width:20px"></td>
								<td>
...
if(type !="all"){
	document.getElementById("filetypeOption").style.display="none";
}
//alert(method);
</script>
